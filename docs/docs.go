...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/auth/resend-business-otp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Resend business OTP details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/auth/verify-business-email": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Business email verification details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "handler.UpdateBusinessRequest": {
            ...
            "properties": {
                ...
                "logo": {
                    "type": "string",
                    "example": "https://r2.cloudflare.com/businesses/logo.jpg"
                },
                "longitude": {
                    "type": "number",
                    "example": 36.8219
